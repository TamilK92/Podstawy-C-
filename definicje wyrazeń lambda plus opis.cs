...
{   
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Show(10);
            /*
            Console.ReadKey();W C# mozna stozować tzw. wyrażenia
             * lambda korzystając z nowego operatora =>, które mają zastapić 
             * definiowanie anonimowych metod wprowadzonych do C# 2.0 Ogólna składnia wyrazeń lambda to:
             * (parametry) => wartość
